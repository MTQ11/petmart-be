...
router.get('/get-promotion',authMemberMiddleWare, promotionController.getAll)
router.post('/create-promotion',authMemberMiddleWare, promotionController.createPromotion)
